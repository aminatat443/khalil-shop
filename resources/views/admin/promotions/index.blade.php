...
<div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
    <h1 class="font-display text-3xl font-normal italic text-secondary-shade dark:text-white">Promotions</h1>
    @can('create', App\Models\Promotion::class)
        <a href="{{ route('admin.promotions.create') }}" class="block bg-secondary-shade px-6 py-3 text-center text-xs font-semibold uppercase tracking-[0.15em] text-white shadow-sm transition hover:bg-primary hover:shadow-md sm:inline-block">
            Nouvelle promotion
        </a>
    @endcan
</div>
