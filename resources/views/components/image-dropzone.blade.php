@props(['name' => 'images[]', 'multiple' => true, 'autoSubmit' => false, 'compact' => false])
...
>
    @if($compact)
        <div
            ...
            :class="dragging ? 'border-primary bg-primary-tint/40 dark:bg-primary/10' : 'border-secondary-shade/20 hover:border-primary hover:text-primary dark:border-white/15'"
            class="flex aspect-square cursor-pointer items-center justify-center border-2 border-dashed text-secondary-shade/40 transition"
